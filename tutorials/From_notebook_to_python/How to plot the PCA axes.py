...
# <div class="toc"><ul class="toc-item"><li><span><a href="#Introduction" data-toc-modified-id="Introduction-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>Introduction</a></span></li><li><span><a href="#Principal-Component-Analysis---Key-Ideas" data-toc-modified-id="Principal-Component-Analysis---Key-Ideas-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>Principal Component Analysis - Key Ideas</a></span><ul class="toc-item"><li><span><a href="#Imports-&amp;-Settings" data-toc-modified-id="Imports-&amp;-Settings-2.1"><span class="toc-item-num">2.1&nbsp;&nbsp;</span>Imports &amp; Settings</a></span></li><li><span><a href="#Linear-Projection:-Principal-Component-Analysis" data-toc-modified-id="Linear-Projection:-Principal-Component-Analysis-2.2"><span class="toc-item-num">2.2&nbsp;&nbsp;</span>Linear Projection: Principal Component Analysis</a></span><ul class="toc-item"><li><span><a href="#Create-Noisy,-Correlated-Data-from-Signal" data-toc-modified-id="Create-Noisy,-Correlated-Data-from-Signal-2.2.1"><span class="toc-item-num">2.2.1&nbsp;&nbsp;</span>Create Noisy, Correlated Data from Signal</a></span></li><li><span><a href="#Compute-Principal-Components" data-toc-modified-id="Compute-Principal-Components-2.2.2"><span class="toc-item-num">2.2.2&nbsp;&nbsp;</span>Compute Principal Components</a></span><ul class="toc-item"><li><span><a href="#Check-share-of-explained-variance" data-toc-modified-id="Check-share-of-explained-variance-2.2.2.1"><span class="toc-item-num">2.2.2.1&nbsp;&nbsp;</span>Check share of explained variance</a></span></li></ul></li><li><span><a href="#Components-are-orthogonal-to-each-other" data-toc-modified-id="Components-are-orthogonal-to-each-other-2.2.3"><span class="toc-item-num">2.2.3&nbsp;&nbsp;</span>Components are orthogonal to each other</a></span></li><li><span><a href="#Plot-Principal-Components-as-new-Basis-Vectors" data-toc-modified-id="Plot-Principal-Components-as-new-Basis-Vectors-2.2.4"><span class="toc-item-num">2.2.4&nbsp;&nbsp;</span>Plot Principal Components as new Basis Vectors</a></span></li><li><span><a href="#Project-2D-data-onto-the-first-Principal-Component" data-toc-modified-id="Project-2D-data-onto-the-first-Principal-Component-2.2.5"><span class="toc-item-num">2.2.5&nbsp;&nbsp;</span>Project 2D data onto the first Principal Component</a></span></li><li><span><a href="#Plot-1D-Representation" data-toc-modified-id="Plot-1D-Representation-2.2.6"><span class="toc-item-num">2.2.6&nbsp;&nbsp;</span>Plot 1D Representation</a></span></li><li><span><a href="#Compare-to-Linear-Regression" data-toc-modified-id="Compare-to-Linear-Regression-2.2.7"><span class="toc-item-num">2.2.7&nbsp;&nbsp;</span>Compare to Linear Regression</a></span></li></ul></li><li><span><a href="#Combined-Figure" data-toc-modified-id="Combined-Figure-2.3"><span class="toc-item-num">2.3&nbsp;&nbsp;</span>Combined Figure</a></span><ul class="toc-item"><li><span><a href="#Recover-Data-using-Inverse-Transformation-1D-=>-2D" data-toc-modified-id="Recover-Data-using-Inverse-Transformation-1D-=>-2D-2.3.1"><span class="toc-item-num">2.3.1&nbsp;&nbsp;</span>Recover Data using Inverse Transformation 1D =&gt; 2D</a></span></li><li><span><a href="#Projection-and-inverse-transformation-lead-to-the-same-result" data-toc-modified-id="Projection-and-inverse-transformation-lead-to-the-same-result-2.3.2"><span class="toc-item-num">2.3.2&nbsp;&nbsp;</span>Projection and inverse transformation lead to the same result</a></span></li></ul></li></ul></li><li><span><a href="#References" data-toc-modified-id="References-3"><span class="toc-item-num">3&nbsp;&nbsp;</span>References</a></span></li></ul></div>
...
# - https://github.com/stefan-jansen/machine-learning-for-trading/blob/main/13_unsupervised_learning/01_linear_dimensionality_reduction/01_pca_key_ideas.ipynb
# 
# </font>
# </div>
