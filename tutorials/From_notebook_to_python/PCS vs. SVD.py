...
# <div class="toc"><ul class="toc-item"><li><span><a href="#Introduction" data-toc-modified-id="Introduction-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>Introduction</a></span></li><li><span><a href="#How-the-PCA-algorithm-works" data-toc-modified-id="How-the-PCA-algorithm-works-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>How the PCA algorithm works</a></span></li><li><span><a href="#Imports" data-toc-modified-id="Imports-3"><span class="toc-item-num">3&nbsp;&nbsp;</span>Imports</a></span><ul class="toc-item"><li><span><a href="#Create-a-noisy-3D-Ellipse" data-toc-modified-id="Create-a-noisy-3D-Ellipse-3.1"><span class="toc-item-num">3.1&nbsp;&nbsp;</span>Create a noisy 3D Ellipse</a></span><ul class="toc-item"><li><span><a href="#Plot-the-result" data-toc-modified-id="Plot-the-result-3.1.1"><span class="toc-item-num">3.1.1&nbsp;&nbsp;</span>Plot the result</a></span></li></ul></li><li><span><a href="#Principal-Components-using-scikit-learn" data-toc-modified-id="Principal-Components-using-scikit-learn-3.2"><span class="toc-item-num">3.2&nbsp;&nbsp;</span>Principal Components using scikit-learn</a></span><ul class="toc-item"><li><span><a href="#First-principal-component" data-toc-modified-id="First-principal-component-3.2.1"><span class="toc-item-num">3.2.1&nbsp;&nbsp;</span>First principal component</a></span></li><li><span><a href="#Explained-Variance" data-toc-modified-id="Explained-Variance-3.2.2"><span class="toc-item-num">3.2.2&nbsp;&nbsp;</span>Explained Variance</a></span></li><li><span><a href="#PCA-to-reduce-dimensions" data-toc-modified-id="PCA-to-reduce-dimensions-3.2.3"><span class="toc-item-num">3.2.3&nbsp;&nbsp;</span>PCA to reduce dimensions</a></span></li></ul></li><li><span><a href="#Principal-Components-from-Covariance-Matrix" data-toc-modified-id="Principal-Components-from-Covariance-Matrix-3.3"><span class="toc-item-num">3.3&nbsp;&nbsp;</span>Principal Components from Covariance Matrix</a></span><ul class="toc-item"><li><span><a href="#Eigendecomposition:-Eigenvectors-&amp;-Eigenvalues" data-toc-modified-id="Eigendecomposition:-Eigenvectors-&amp;-Eigenvalues-3.3.1"><span class="toc-item-num">3.3.1&nbsp;&nbsp;</span>Eigendecomposition: Eigenvectors &amp; Eigenvalues</a></span></li><li><span><a href="#eigenvectors-=-principal-components" data-toc-modified-id="eigenvectors-=-principal-components-3.3.2"><span class="toc-item-num">3.3.2&nbsp;&nbsp;</span>eigenvectors = principal components</a></span><ul class="toc-item"><li><span><a href="#eigenvalues-=-explained-variance" data-toc-modified-id="eigenvalues-=-explained-variance-3.3.2.1"><span class="toc-item-num">3.3.2.1&nbsp;&nbsp;</span>eigenvalues = explained variance</a></span></li><li><span><a href="#Check-that-Eigendecomposition-works" data-toc-modified-id="Check-that-Eigendecomposition-works-3.3.2.2"><span class="toc-item-num">3.3.2.2&nbsp;&nbsp;</span>Check that Eigendecomposition works</a></span></li></ul></li><li><span><a href="#Preferred:-Singular-Value-Decomposition" data-toc-modified-id="Preferred:-Singular-Value-Decomposition-3.3.3"><span class="toc-item-num">3.3.3&nbsp;&nbsp;</span>Preferred: Singular Value Decomposition</a></span><ul class="toc-item"><li><span><a href="#Requires-centering-your-data!" data-toc-modified-id="Requires-centering-your-data!-3.3.3.1"><span class="toc-item-num">3.3.3.1&nbsp;&nbsp;</span>Requires centering your data!</a></span></li><li><span><a href="#Show-that-the-result-indeed-decomposes-the-original-data" data-toc-modified-id="Show-that-the-result-indeed-decomposes-the-original-data-3.3.3.2"><span class="toc-item-num">3.3.3.2&nbsp;&nbsp;</span>Show that the result indeed decomposes the original data</a></span></li><li><span><a href="#Confirm-that-$V^T$-contains-the-principal-components" data-toc-modified-id="Confirm-that-$V^T$-contains-the-principal-components-3.3.3.3"><span class="toc-item-num">3.3.3.3&nbsp;&nbsp;</span>Confirm that $V^T$ contains the principal components</a></span></li></ul></li><li><span><a href="#Visualize-2D-Projection" data-toc-modified-id="Visualize-2D-Projection-3.3.4"><span class="toc-item-num">3.3.4&nbsp;&nbsp;</span>Visualize 2D Projection</a></span></li><li><span><a href="#2D-Representation" data-toc-modified-id="2D-Representation-3.3.5"><span class="toc-item-num">3.3.5&nbsp;&nbsp;</span>2D Representation</a></span></li><li><span><a href="#How-many-Components-to-represent-64-dimensions?" data-toc-modified-id="How-many-Components-to-represent-64-dimensions?-3.3.6"><span class="toc-item-num">3.3.6&nbsp;&nbsp;</span>How many Components to represent 64 dimensions?</a></span><ul class="toc-item"><li><span><a href="#Evaluate-the-cumulative-explained-variance" data-toc-modified-id="Evaluate-the-cumulative-explained-variance-3.3.6.1"><span class="toc-item-num">3.3.6.1&nbsp;&nbsp;</span>Evaluate the cumulative explained variance</a></span></li></ul></li><li><span><a href="#Automate-generation-of-Components" data-toc-modified-id="Automate-generation-of-Components-3.3.7"><span class="toc-item-num">3.3.7&nbsp;&nbsp;</span>Automate generation of Components</a></span></li></ul></li></ul></li><li><span><a href="#References" data-toc-modified-id="References-4"><span class="toc-item-num">4&nbsp;&nbsp;</span>References</a></span></li></ul></div>
...
# <font color=black>
# 
# - https://github.com/stefan-jansen/machine-learning-for-trading/blob/main/13_unsupervised_learning/01_linear_dimensionality_reduction/02_the_math_behind_pca.ipynb
